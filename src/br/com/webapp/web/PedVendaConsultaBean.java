...
@ManagedBean(name = "pedVendaConsultaBean")
@SessionScoped
public class PedVendaConsultaBean implements Serializable, IMenuAcesso{

	private static final long serialVersionUID = -5501425284814883822L;
	
	// Menu Acesso
	private Integer menu = MenuAcessoController.PEDVENDA_CONSULTA_BEAN;
	...
	public List<PedVendaFBDTO> getLista() {
		if (lista == null) {
			...
			lista = new PedVendaFBDTORN().listar(numPedidoFilter, tipoDataFilter, dataFilter1, dataFilter2, empresaFilter, vendedorFilter, clienteFilter, statusFilter, carteiraFilter, Funcoes.IS_VENDA, contextoBean.getUsuarioLogado());
			valorTotal = 0.0;
