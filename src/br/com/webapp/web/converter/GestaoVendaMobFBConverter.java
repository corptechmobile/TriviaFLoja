...
@FacesConverter(forClass = GestaoVendaMobFB.class)
public class GestaoVendaMobFBConverter  implements Converter {
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		if (value != null && value.trim().length() > 0) {
			try {
				GestaoVendaMobFBRN gestaoVendaMobFBRN = new GestaoVendaMobFBRN();
				return gestaoVendaMobFBRN.carregar(Integer.parseInt(value));
			} catch (Exception e) {
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		if (value != null) {
			GestaoVendaMobFB gestaoVendaMobFB = (GestaoVendaMobFB) value;
			return "" + gestaoVendaMobFB.getId();
		}
		return "";
	}
