...
@FacesConverter(forClass = TelefoneTipoFB.class)
public class TelefoneTipoFBConverter implements Converter {
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		if (value != null && value.trim().length() > 0) {
			Integer codigo = Integer.valueOf(value);
			try {
				TelefoneTipoFBRN telefoneTipoRN = new TelefoneTipoFBRN();
				return telefoneTipoRN.carregar(codigo);
			} catch (Exception e) {
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		if (value != null) {
			TelefoneTipoFB telefoneTipo = (TelefoneTipoFB) value;
			return "" + telefoneTipo.getId();
		}
		return "";
	}
}
